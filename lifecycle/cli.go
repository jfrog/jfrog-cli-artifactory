...
func GetCommands() []components.Command {
	return []components.Command{
		...
		},
		{
			...
			AIDescription: rbUpdate.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: rbFinalize.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: rbExport.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: rbDeleteLocal.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: rbDeleteRemote.GetAIDescription(),
			Arguments:     rbDeleteLocal.GetArguments(),
			Category:      lcCategory,
			Action:        deleteRemote,
		},
		{
			...
			AIDescription: rbImport.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: rbAnnotate.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: rbsearch.GetAIDescription(),

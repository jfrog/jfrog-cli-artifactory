...
Common patterns:
  ...
  $ jf release-bundle-distribute my-bundle 1.0.0 --site="edge-eu" --include-evidence --sync
...
- --include-evidence also moves Evidence on the bundle and its artifacts to the target (server support required).

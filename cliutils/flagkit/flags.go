...
var commandFlags = map[string][]string{
	...
	cmddefs.ReleaseBundleCreate: {
		...
		specFlag, specVars, BuildName, BuildNumber, SourcesReleaseBundles, SourcesBuilds,
	},
...
var flagsMap = map[string]components.Flag{
	...
	SourcesReleaseBundles: components.NewStringFlag(SourcesReleaseBundles, "List of semicolon-seperated(;) release bundles in the form of 'name=releaseBundleName1, version=version1; name=releaseBundleName2, version=version2' to be included in the new bundle.", components.SetMandatoryFalse()),
	SourcesBuilds:         components.NewStringFlag(SourcesBuilds, "List of semicolon-separated(;) builds in the form of 'name=buildName1, id=runID1, include-deps=true; name=buildName2, id=runID2' to be included in the new bundle.", components.SetMandatoryFalse()),
}

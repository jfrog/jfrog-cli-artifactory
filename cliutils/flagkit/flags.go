...
var flagsMap = map[string]components.Flag{
	...
	downloadRecursive:       components.NewBoolFlag(Recursive, "[Default: true] Set to false if you do not wish to include the download of artifacts inside sub-folders in Artifactory.", components.WithBoolDefaultValueTrue()),
	...
	includeDeps:             components.NewBoolFlag(includeDeps, "[Default: false] If specified, also dependencies of the specified build are matched. Used together with the --build flag.", components.WithBoolDefaultValueFalse()),
	excludeArtifacts:        components.NewBoolFlag(excludeArtifacts, "[Default: false] If specified, build artifacts are not matched. Used together with the --build flag.", components.WithBoolDefaultValueFalse()),

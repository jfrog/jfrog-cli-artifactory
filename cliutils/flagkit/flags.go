...
var flagsMap = map[string]components.Flag{
	...
	includeDeps:             components.NewBoolFlag(includeDeps, "If specified, also dependencies of the specified build are matched. Used together with the --build flag.", components.WithBoolDefaultValueFalse()),
	excludeArtifacts:        components.NewBoolFlag(excludeArtifacts, "If specified, build artifacts are not matched. Used together with the --build flag.", components.WithBoolDefaultValueFalse()),

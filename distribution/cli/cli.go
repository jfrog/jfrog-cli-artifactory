	...
	return []components.Command{
		{
			...
			AIDescription: releasebundlecreate.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: releasebundleupdate.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: releasebundlesign.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: releasebundledistribute.GetAIDescription(),
		...
		},
		{
			...
			AIDescription: releasebundledelete.GetAIDescription(),

...
var flagsMap = map[string]components.Flag{
	...
	site:               components.NewStringFlag(site, "Wildcard filter for site name.", WithStrDefaultValue("*")),
	city:               components.NewStringFlag(city, "Wildcard filter for site city name.", WithStrDefaultValue("*")),
	countryCodes:       components.NewStringFlag(countryCodes, "List of semicolon-separated(;) wildcard filters for site country codes.", WithStrDefaultValue("*")),

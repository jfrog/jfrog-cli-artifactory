...
var flagsMap = map[string]components.Flag{
	...
	releaseNotesSyntax: components.NewStringFlag(releaseNotesSyntax, "[Default: plain_text] The syntax for the release notes. Can be one of 'markdown', 'asciidoc', or 'plain_text.", WithStrDefaultValue("plain_text")),
	...
	site:               components.NewStringFlag(site, "Wildcard filter for site name.", WithStrDefaultValue("*"), SetMandatoryFalse()),
	city:               components.NewStringFlag(city, "Wildcard filter for site city name.", WithStrDefaultValue("*"), SetMandatoryFalse()),
	countryCodes:       components.NewStringFlag(countryCodes, "List of semicolon-separated(;) wildcard filters for site country codes.", WithStrDefaultValue("*"), SetMandatoryFalse()),

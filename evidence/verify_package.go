...
func NewVerifyEvidencePackage(serverDetails *coreConfig.ServerDetails, format, packageName, packageVersion, packageRepoName string, keys []string) Command {
...
func (c *verifyEvidencePackage) Run() error {
	...
	return c.verifyEvidences(artifactoryClient, metadata, packageSha256)
}

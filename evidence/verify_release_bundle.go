...
func NewVerifyEvidenceReleaseBundle(serverDetails *coreConfig.ServerDetails, format, project, releaseBundle, releaseBundleVersion string, keys []string, useArtifactoryKeys bool) Command {

...
func NewVerifyEvidenceReleaseBundle(serverDetails *coreConfig.ServerDetails, format, project, releaseBundle, releaseBundleVersion string, keys []string) Command {
...
func (c *verifyEvidenceReleaseBundle) ServerDetails() (*coreConfig.ServerDetails, error) {
...
func (c *verifyEvidenceReleaseBundle) Run() error {
	...
	return c.verifyEvidences(artifactoryClient, metadata, releaseBundleSha256)
}

...
func (m *MockArtifactoryServicesManagerBuild) GetTrustedKeys() (*services.TrustedKeysResponse, error) {
	// Return empty response to avoid method not implemented error
	return &services.TrustedKeysResponse{}, nil
}

func (m *MockArtifactoryServicesManagerBuild) GetKeyPairs() (*[]services.KeypairResponseItem, error) {
	// Return empty response to avoid method not implemented error
